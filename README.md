...
I made this entire Wiki, aside from 10-20% of the plain text content, for my Senior project at University, on behalf of a company called "Sawtooth Software". Though the site was made using DokuWiki, the built-in Wiki markdown was largely ignored in favor of custom Javascript, HTML, and CSS that I wrote. This was necessary to make the site's functionality and style conform to my vision.
